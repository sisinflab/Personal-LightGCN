...
from .LightGCNPModel import LightGCNPModel

from torch_sparse import SparseTensor


class LightGCNP(RecMixin, BaseRecommenderModel):
    @init_charger
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            ("_a", "a", "a", 0.5, float, None),
            ("_b", "b", "b", 0.5, float, None)
        ]
        self.autoset_params()
